...
struct VkSupportedFormatInfo_t
{
	...
	// Whether the device can sample the BC block formats at all. Every desktop
	// GPU can; Mali reports none of them, and the fallback in
	// GetTextureFormatInfoVK decompresses on upload instead.
	bool fmt_bc1{};
	bool fmt_bc2{};
	bool fmt_bc3{};
	bool fmt_bc4{};
